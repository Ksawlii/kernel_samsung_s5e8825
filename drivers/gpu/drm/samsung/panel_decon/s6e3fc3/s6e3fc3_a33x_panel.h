...
static u8 a33x_elvss_table[S6E3FC3_TOTAL_STEP][1] = {
	/* OVER_ZERO */
	[0 ... 255] = { 0x16 },
	/* HBM */
	[256 ... 270] = { 0x26 },
...
static u8 a33x_acl_opr_table[ACL_OPR_MAX][1] = {
	{ 0x00 }, /* ACL OFF OPR */
	{ 0x01 }, /* ACL ON OPR_3 */
	{ 0x01 }, /* ACL ON OPR_6 */
	{ 0x01 }, /* ACL ON OPR_8 */
...
static u8 A33X_TE_OFFSET[] = { 0xB9, 0x01, 0x09, 0x58, 0x00, 0x0B};
...
static DEFINE_STATIC_PACKET(a33x_te_offset, DSI_PKT_TYPE_WR, A33X_TE_OFFSET, 0);
...
static u8 A33X_LPM_PORCH_0_ON[] = { 0xCB, 0x30, 0x19, 0x00, 0x00, 0x00, 0x00, 0x30 };
static DEFINE_STATIC_PACKET(a33x_lpm_porch_0_on, DSI_PKT_TYPE_WR, A33X_LPM_PORCH_0_ON, 0x188);

static u8 A33X_LPM_PORCH_1_ON[] = { 0xCB, 0x38, 0x00, 0x00, 0x00, 0x18, 0x03, 0x38 };
static DEFINE_STATIC_PACKET(a33x_lpm_porch_1_on, DSI_PKT_TYPE_WR, A33X_LPM_PORCH_1_ON, 0x1C0);

static u8 A33X_LPM_PORCH_2_ON[] = { 0xF2, 0x24, 0xA0};
static DEFINE_STATIC_PACKET(a33x_lpm_porch_2_on, DSI_PKT_TYPE_WR, A33X_LPM_PORCH_2_ON, 0x10);


static u8 A33X_SWIRE_NO_PULSE[] = { 0xB5, 0x00, 0x00, 0x00 };
static DEFINE_STATIC_PACKET(a33x_swire_no_pulse, DSI_PKT_TYPE_WR, A33X_SWIRE_NO_PULSE, 0x07);

static u8 A33X_LPM_PORCH_0_OFF[] = { 0xCB, 0x35, 0x19, 0x00, 0x00, 0x00, 0x00, 0x35 };
static DEFINE_STATIC_PACKET(a33x_lpm_porch_0_off, DSI_PKT_TYPE_WR, A33X_LPM_PORCH_0_OFF, 0x188);

static u8 A33X_LPM_PORCH_1_OFF[] = { 0xCB, 0x3D, 0x00, 0x00, 0x00, 0x18, 0x03, 0x3D };
static DEFINE_STATIC_PACKET(a33x_lpm_porch_1_off, DSI_PKT_TYPE_WR, A33X_LPM_PORCH_1_OFF, 0x1C0);

static u8 A33X_LPM_PORCH_2_OFF[] = { 0xF2, 0x26, 0xE9 };
static DEFINE_STATIC_PACKET(a33x_lpm_porch_2_off, DSI_PKT_TYPE_WR, A33X_LPM_PORCH_2_OFF, 0x10);
...
static DEFINE_PANEL_MDELAY(a33x_wait_sleep_out_90msec, 90);
...
static DEFINE_COND(a33x_cond_is_60hz, s6e3fc3_is_60hz);
static DEFINE_COND(a33x_cond_is_120hz, s6e3fc3_is_120hz);
#endif
...
static DECLARE_PKTUI(a33x_acl_set) = {
	...
	{ .offset = 19, .maptbl = &a33x_maptbl[ACL_DIM_SPEED_MAPTBL] },
};
...
static DEFINE_STATIC_PACKET(a33x_ffc_default_set_1, DSI_PKT_TYPE_WR, A33X_FFC_DEFAULT_SET_1, 0x2A);
static u8 A33X_FFC_DEFAULT_SET_2[] = {
	0xC5,
	0x34, 0x40
};
...
static u8 A33X_DIMMING_SPEED[] = { 0x63, 0x00};
...
static u8 A33X_FOD_ENTER_1[] = {
	0x63, 0xF1, 0x00
};
static DEFINE_STATIC_PACKET(a33x_fod_enter_1, DSI_PKT_TYPE_WR, A33X_FOD_ENTER_1, 0x203);

static u8 A33X_FOD_ENTER_2[] = {
	0xB5, 0x14
};
static DEFINE_STATIC_PACKET(a33x_fod_enter_2, DSI_PKT_TYPE_WR, A33X_FOD_ENTER_2, 0);

static u8 A33X_FOD_ENTER_3[] = {
	0x63, 0xF0, 0x07
};
static DEFINE_STATIC_PACKET(a33x_fod_enter_3, DSI_PKT_TYPE_WR, A33X_FOD_ENTER_3, 0x203);

static u8 A33X_FOD_EXIT_1[] = {
	0x63, 0xF1, 0x07
};
static DEFINE_STATIC_PACKET(a33x_fod_exit_1, DSI_PKT_TYPE_WR, A33X_FOD_EXIT_1, 0x203);

static u8 A33X_FOD_EXIT_2[] = {
	0xB5, 0x14
};
static DEFINE_STATIC_PACKET(a33x_fod_exit_2, DSI_PKT_TYPE_WR, A33X_FOD_EXIT_2, 0);

static u8 A33X_FOD_EXIT_3[] = {
	0x63, 0xF0, 0x00
};
static DEFINE_STATIC_PACKET(a33x_fod_exit_3, DSI_PKT_TYPE_WR, A33X_FOD_EXIT_3, 0x203);

static u8 A33X_DSC[] = { 0x01 };
static DEFINE_STATIC_PACKET(a33x_dsc, DSI_PKT_TYPE_COMP, A33X_DSC, 0);
...
static DEFINE_STATIC_PACKET(a33x_pps, DSI_PKT_TYPE_PPS, A33X_PPS, 0);
...
static void *a33x_init_cmdtbl[] = {
...
#if defined(CONFIG_MCD_PANEL_FACTORY) && defined(CONFIG_SUPPORT_FAST_DISCHARGE)
	&PKTINFO(a33x_fast_discharge), /* need to check */
#endif
	...
	&DLYINFO(a33x_wait_sleep_out_90msec),
...
static void *a33x_alpm_enter_cmdtbl[] = {
	&KEYINFO(a33x_level1_key_enable),
	&KEYINFO(a33x_level2_key_enable),
	&KEYINFO(a33x_level3_key_enable),
	...
	&PKTINFO(a33x_lpm_porch_0_on),
	&PKTINFO(a33x_lpm_porch_1_on),
	&PKTINFO(a33x_lpm_porch_2_on),
...
static void *a33x_alpm_exit_cmdtbl[] = {
	...
	&PKTINFO(a33x_lpm_porch_0_off),
	&PKTINFO(a33x_lpm_porch_1_off),
	&PKTINFO(a33x_lpm_porch_2_off),
...
static void *a33x_mask_layer_enter_br_cmdtbl[] = {
	...
	&PKTINFO(a33x_acl_control),
	&PKTINFO(a33x_dimming_speed),
	&PKTINFO(a33x_fod_enter_1),
	&PKTINFO(a33x_hbm_transition),
	&PKTINFO(a33x_wrdisbv),
	&PKTINFO(a33x_fod_enter_2),
...
static void *a33x_mask_layer_exit_br_cmdtbl[] = {
	...
	&PKTINFO(a33x_dimming_speed),
	&PKTINFO(a33x_fod_exit_1),
	&PKTINFO(a33x_hbm_transition),
	&PKTINFO(a33x_wrdisbv),
	&PKTINFO(a33x_fod_exit_2),
...
static struct seqinfo a33x_seqtbl[MAX_PANEL_SEQ] = {
	...
	[PANEL_MASK_LAYER_ENTER_BR_SEQ] = SEQINFO_INIT("mask-layer-enter-br-seq", a33x_mask_layer_enter_br_cmdtbl), //temp br
