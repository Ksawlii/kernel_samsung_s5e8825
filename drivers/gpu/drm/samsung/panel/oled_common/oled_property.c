...
struct panel_prop_list usdm_oled_property_array[] = {
	/* enum property */
...
EXPORT_SYMBOL(usdm_oled_property_array);

unsigned int usdm_oled_property_array_size = ARRAY_SIZE(usdm_oled_property_array);
EXPORT_SYMBOL(usdm_oled_property_array_size);
