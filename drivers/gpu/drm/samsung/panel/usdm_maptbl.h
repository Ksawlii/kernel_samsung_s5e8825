...
int usdm_maptbl_get_indexof_n_dimen_element(struct maptbl *m, enum ndarray_dimen dimen, unsigned int indexof_element);
int usdm_maptbl_get_indexof_box(struct maptbl *m, unsigned int indexof_box);
int usdm_maptbl_get_indexof_layer(struct maptbl *m, unsigned int indexof_layer);
int usdm_maptbl_get_indexof_row(struct maptbl *m, unsigned int indexof_row);
int usdm_maptbl_get_indexof_col(struct maptbl *m, unsigned int indexof_col);
...
int usdm_maptbl_index(struct maptbl *m, int layer, int row, int col);
int usdm_maptbl_4d_index(struct maptbl *m, int box, int layer, int row, int col);
bool usdm_maptbl_is_initialized(struct maptbl *m);
bool usdm_maptbl_is_index_in_bound(struct maptbl *m, unsigned int index);
int usdm_maptbl_init(struct maptbl *m);
int usdm_maptbl_getidx(struct maptbl *m);
int usdm_maptbl_copy(struct maptbl *m, u8 *dst);
...
int usdm_maptbl_pos_to_index(struct maptbl *m, struct maptbl_pos *pos);
int usdm_maptbl_index_to_pos(struct maptbl *m, unsigned int index, struct maptbl_pos *pos);
int usdm_maptbl_fill(struct maptbl *m, struct maptbl_pos *pos, u8 *src, size_t n);
...
void usdm_maptbl_print(struct maptbl *m);
