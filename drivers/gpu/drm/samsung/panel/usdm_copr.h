...
static inline int usdm_get_copr_reg_size(int version) { return 0; }
static inline int usdm_get_copr_reg_packed_size(int version) { return 0; }
static inline const char *usdm_get_copr_reg_name(int version, int index) { return NULL; }
static inline int usdm_get_copr_reg_offset(int version, int index) { return 0; }
static inline u32 *usdm_get_copr_reg_ptr(struct copr_reg *reg, int version, int index) { return NULL; }
static inline int usdm_find_copr_reg_by_name(int version, char *s) { return -EINVAL; }
...
static inline int usdm_copr_reg_to_byte_array(struct copr_reg *reg, int version, unsigned char *byte_array) { return 0; }
#endif
#endif /* __COPR_H__ */
