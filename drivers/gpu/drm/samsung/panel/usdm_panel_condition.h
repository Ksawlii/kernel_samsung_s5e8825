...
extern struct condinfo usdm_panel_cond_else;
extern struct condinfo usdm_panel_cond_endif;
...
#define CONDINFO_EL(_condname) (usdm_panel_cond_else)
#define CONDINFO_FI(_condname) (usdm_panel_cond_endif)
