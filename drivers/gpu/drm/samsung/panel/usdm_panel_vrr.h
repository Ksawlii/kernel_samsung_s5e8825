...
struct panel_vrr *usdm_get_panel_vrr(struct panel_device *panel);
int usdm_get_panel_refresh_rate(struct panel_device *panel);
int usdm_get_panel_refresh_mode(struct panel_device *panel);
